...
export function ScreenshotButton({
  ...
  return (
    <button
      ...
      className=" p-2 bg-zinc rounded-md border-transparent hover:bg-zinc-700 transition-colors focus:outline-none focus:ring-2 docus:ring-offset-2 focus:ring-offset-zinc-900 focus:ring-brand-500"
    >
      {isTakenScreenshot ? (
        <Loading />
      ) : (
